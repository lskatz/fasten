...
one_cleaned_read=$(./target/debug/friends_monica --paired-end --min-trim-quality 30 --min-length 94 < testdata/four_reads.pe.fastq | ./target/debug/friends_rachel --each-read | tail -n 1)
